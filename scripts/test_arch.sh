...
echo "=== Arch Linux Dotfiles Installation Test ==="
echo ""
...
echo ""
echo "=== Running: scripts/bootstrap_arch.sh ==="
echo ""

if $CONTAINER_CMD exec --user testuser --workdir /home/testuser/dotfiles/scripts "$CONTAINER_NAME" ./bootstrap_arch.sh; then
...
echo ""
echo "=== Running: make arch ==="
echo ""

# Run make arch as testuser
if $CONTAINER_CMD exec --user testuser --workdir /home/testuser/dotfiles "$CONTAINER_NAME" make arch; then
    echo ""
